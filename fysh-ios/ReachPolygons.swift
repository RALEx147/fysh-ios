...
//  fysh-ios
//
//  Created by Robert Alexander on 10/8/20.
...
struct ReachPolygons {
    struct PennsCreek {
        struct Selin {
			...
			CLLocationCoordinate2D(latitude: 40.77763, longitude:  -76.86491),
			CLLocationCoordinate2D(latitude: 40.78876, longitude:  -76.86164),
			CLLocationCoordinate2D(latitude: 40.81368, longitude:  -76.85214),
			CLLocationCoordinate2D(latitude: 40.81471, longitude:  -76.85755),
			CLLocationCoordinate2D(latitude: 40.79470, longitude:  -76.86458),
